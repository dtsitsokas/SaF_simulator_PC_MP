function gplotdc_colormap(A,xy,a,varargin)
...
% plot(dX,dY,'Color',COLOR(a),params,'Linewidth',1.5)


%COLOR = [0, 0.4470, 0.7410; 0.8500, 0.3250, 0.0980; 0.4660, 0.6740, 0.1880; 0.9290, 0.6940, 0.1250; 0.4940, 0.1840, 0.5560; 0.3010, 0.7450, 0.9330; 0, 0, 0];
% plot(dX,dY,'Color',COLOR(a,:),params,'Linewidth',1.5)
...
plot(dX,dY,'Color',myColorMap(ceil(a*256),:),params,'Linewidth',3+(a>=0.96||a<=0.1)*1.5)
