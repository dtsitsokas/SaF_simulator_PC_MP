function gplotdc(A,xy,a,varargin)
...
COLOR = load('cmap_parula.mat','cmap');
aa = min(size(COLOR.cmap,1),max(1,round(a*size(COLOR.cmap,1))));
plot(dX,dY,'Color',COLOR.cmap(aa,:),params,'Linewidth',1.5)
