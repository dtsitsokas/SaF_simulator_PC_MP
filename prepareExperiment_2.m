...
function [] = prepareExperiment_2(x,y,caseName,demandCase)
% clear 
% clc
% close all 
%% Set Scenario Name here: 

scenario = strcat('PC_62_MP_R',num2str(x),'_',num2str(y));
% scenario = strcat('PC_50b_MP_R',num2str(x),'_',num2str(y));

notes = 'PC_61 + MP random, x percent%';
...
%caseName = strcat('MP_cd_MS',num2str(x));  %MP case to load on the scenario 
%caseName = scenario; 
...
PC.mode = 1; %on/off for the specified intersections 
if PC.mode == 1
...
%     PC.deactCrit = 0.15; 
   ...
   if demandCase==2 
       load('C:\Users\tsitsoka\Documents\Dimitris Local Documents pc10\GitHub-My repositories\MaxPressure_Codes-\runs medium demand\input_PC_50b.mat','PC')  %for high demand 
   elseif demandCase==1
%        load('C:\Users\tsitsoka\Documents\Dimitris Local Documents pc10\GitHub-My repositories\MaxPressure_Codes-\runs medium demand\input_PC_61.mat','PC')  %for medium demand        
       load('C:\Users\tsitsoka\Documents\Dimitris Local Documents pc10\GitHub-My repositories\MaxPressure_Codes-\runs medium demand\input_PC_62.mat','PC')  %for medium demand 
   end
