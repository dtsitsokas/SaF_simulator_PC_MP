function [] = createSnapshot_2(snap_t,DT,metric,metric_n,metric_name,LINKS,Nodes)
...
%line_1
plot([x1_l1; x2_l1],[y1_l1; y2_l1],'Linewidth',4,'Color','k')

%line_2 
plot([x2_l1; x1_l2],[y2_l1; y1_l2],'Linewidth',4,'Color','k')

%line_3
plot([x1_l2; x1_l3],[y1_l2; y1_l3],'Linewidth',4,'Color','k')

%line_4 
plot([x1_l3; x1_l1],[y1_l3; y1_l1],'Linewidth',4,'Color','k')
end
