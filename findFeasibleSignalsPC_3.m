function [out_1,out_2] = findFeasibleSignalsPC_3(agg_u, greens_P, avg_x ,or_index, gn_R, PC, ind, twin_ind, minG, sat_flows,alpha,beta)
...
%(the one Nikolas wants - slightly worse) 
